        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="ml-auto">
                        <button type="button" class="btn btn-primary float-right mt-3 mx-3" data-toggle="modal" data-target="#comodity_locations_create"><i class="fa fa-plus"></i> Add Ruangan</button>
                    </div>
                </div>
                <div class="card-body">
