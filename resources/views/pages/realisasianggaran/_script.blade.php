    ...
    function edit_data(id) {
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                $('#anggaran_edit').val(data.data.anggaran);
                $('#realisasi_edit').val(data.data.realisasi);
                $('#bulan_edit').val(data.data.bulan);
    ...
    function show_data(id) {
        $.ajax({
            ...
            success: function(data) {
                ...
                $('#anggaran_show').html(data.data.anggaran);
                $('#realisasi_show').html(data.data.realisasi);
                $('#selisih_show').html(data.data.selisih);
                $('#bulan_show').html(data.data.bulan);
                $('#tahun_show').html(data.data.tahun);
