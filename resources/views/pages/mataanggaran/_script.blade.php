<script type="text/javascript">
    ...
    function edit_data(id) {
        ...
        $.ajax({
            type: "GET",
            dataType: "json",
            url: "{{ asset('mataanggaran/edit') }}/" + id,
            data: {
                id: id,
                _token: token
            },
        ...
        $('#swal-update-button').click(function(e) {
            ...
            $.ajax({
                type: "PUT",
                dataType: "json",
                url: "{{ asset('mataanggaran/update') }}/" + id,
                data: {
                    _token: token,
                    name: $('#kode_edit').val(),
                    description: $('#nama_edit').val(),
                },
                cache: false,
                beforeSend: function() {
                    in_load();
    ...
    function show_data(id) {
        $.ajax({
            type: "GET",
            dataType: "json",
            url: "{{ asset('mataanggaran/show') }}/" + id,
        ...
        swal({
            ...
            if (deleteFile) {
                $.ajax({
                    type: "POST",
                    dataType: "json",
                    url: "{{ asset('/mataanggaran/destroy') }}/" + id,
