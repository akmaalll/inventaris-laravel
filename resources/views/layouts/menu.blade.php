<aside id="sidebar-wrapper">
  ...
  <ul class="sidebar-menu">
    ...
    <li class="nav-item dropdown {{ Request::is(['tabungan*', 'kaskecil*', 'realisasianggaran*']) ? 'show active' : '' }}" data-dropdown-category="data_keuangan">
      <a href="#" class="nav-link has-dropdown" data-toggle="dropdown"><i class="fa fa-credit-card"></i> <span>Data Keuangan</span></a>
      <ul class="dropdown-menu" data-dropdown-category="data_keuangan">
        <li class="{{ Request::is('kaskecil*') ? 'active' : '' }}"><a class="nav-link" href="{{ asset('kaskecil') }}">Kas Kecil</a></li>
        <li class="{{ Request::is('tabungan*') ? 'active' : '' }}"><a class="nav-link" href="{{ asset('tabungan') }}">Tabungan</a></li>
        <li class="{{ Request::is('realisasianggaran*') ? 'active' : '' }}"><a class="nav-link" href="{{ asset('realisasianggaran') }}">Realisasi Anggaran</a></li>
      </ul>
    </li>
